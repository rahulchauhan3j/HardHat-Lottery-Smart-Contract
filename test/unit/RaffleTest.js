  ...
  : describe("Raffle Unit Tests", function () {
      ...
      describe("enterRaffle", function () {
        ...
        it("records players when they enter raffle", async function () {
          ...
          const payerFromContract = await raffle.getPlayer(0)
          assert.equal(payerFromContract, deployer)
        })
        ...
        it("doesnt allow entrance when raffle is not open", async function () {
          await raffle.enterRaffle({ value: raffleEntranceFee })
